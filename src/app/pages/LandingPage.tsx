...
// Complete landing page with all sections (Navbar, Hero, Features, etc.)
// ============================================================================
...
function NavBar({ onLoginClick, onContactClick }: { onLoginClick: () => void; onContactClick: () => void }) {
          ...
          {features.map((feature, index) => (
            <motion.div key={feature.title} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: index * 0.1 }}>
              <Card className="h-full border-2 border-gray-300 rounded-2xl p-6 flex flex-col">
                <div className={`mb-1 inline-flex items-center gap-2 rounded-lg ${feature.bgColor} p-3 w-full`}>
...
function DashboardPreviewSection() {
  ...
  return (
    <div id="dashboard" className="bg-gray-50 py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
...
function BenefitsSection() {
  return (
    <div id="benefits" className="relative bg-gradient-to-b from-green-900 via-green-800 to-green-900 py-32 sm:py-40 overflow-hidden">
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-gray-900">info@omnibins.com</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-full bg-green-50 flex items-center justify-center flex-shrink-0">
